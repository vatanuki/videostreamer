...
*/
	...
	#define _LOG_DBG_V //(b,args...) filelogem("[D] %s:%d: "b"\n",__FUNCTION__,__LINE__,##args);
	...
	#define _LOG_DBG_V //(b,args...) filelogth("[D] %s:%d: "b"\n",__FUNCTION__,__LINE__,##args);
	...
	#define _LOG_DBG_V(b,args...) syslog(LOG_DEBUG,"[D] %s:%d: "b,__FUNCTION__,__LINE__,##args);
	...
	#define _LOG_DBG_V(b,args...) printf("[D] %s:%d: "b"\n",__FUNCTION__,__LINE__,##args);
